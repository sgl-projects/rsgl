...
test_that(
  "valid_aesthetics doesn't raise error for x and y positional aesthetics",
  {
    rgs <- sgl_to_rgs("
			visualize
				hp as x,
...
test_that("valid_aesthetics doesn't raise error if only y is present", {
  rgs <- sgl_to_rgs("
    visualize
      mpg as y
    from cars
...
test_that("valid_aesthetics doesn't raise error if only x is present", {
  rgs <- sgl_to_rgs("
    visualize
      hp as x
    from cars
...
test_that(
  "valid_aesthetics doesn't raise error for r and theta positional aesthetics",
  {
    rgs <- sgl_to_rgs("
			visualize
				hp as r,
...
test_that("valid_aesthetics doesn't raise error if only theta is present", {
  rgs <- sgl_to_rgs("
    visualize
      mpg as theta
    from cars
...
test_that("valid_aesthetics doesn't raise error if only r is present", {
  rgs <- sgl_to_rgs("
    visualize
      hp as r
    from cars
...
test_that("valid_aesthetics doesn't raise error for color aesthetic", {
  rgs <- sgl_to_rgs("
    visualize
      hp as x,
      mpg as y,
...
test_that("valid_aesthetics doesn't raise error for size aesthetic", {
  rgs <- sgl_to_rgs("
    visualize
      hp as x,
      mpg as y,
...
test_that(
  "valid_aesthetics doesn't raise error for size with other coordinate systems",
  {
    rgs <- sgl_to_rgs("
			visualize
				hp as r,
