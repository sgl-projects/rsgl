new_sgl_geom_violin <- function() {
  new_sgl_geom(class = "sgl_geom_violin")
}

#' @export
geom_name.sgl_geom_violin <- function(geom) {
  "violin"
}

#' @export
is_collective.sgl_geom_violin <- function(geom) {
  TRUE
}

#' @export
valid_non_pos_aes.sgl_geom_violin <- function(geom) {
  "color"
}

#' @export
extension.sgl_geom_violin <- function(geom) {
  1
}

#' @export
ggplot_geom.sgl_geom_violin <- function(geom) {
  ggplot2::geom_violin
}

#' @export
group_aes_cols.sgl_geom_violin <- function(geom, layer, df, scales) {
...
#' @export
ggplot_aes.sgl_geom_violin <- function(geom, layer, df, scales) {
...
#' @export
valid_qual_list.sgl_geom_violin <- function(geom) {
  c(
    "horizontal",
    "vertical"
  )
...
#' @export
has_direction.sgl_geom_violin <- function(geom) {
  TRUE
}

#' @export
ggplot_orntn_from_qual.sgl_geom_violin <- function(geom, qual) {
  if (qual == "vertical") {
    return("x")
  }
  "y"
