...
enum yysymbol_kind_t
{
  ...
  YYSYMBOL_graphic_clauses = 25,           /* graphic_clauses  */
  YYSYMBOL_graphic_clause = 26,            /* graphic_clause  */
  YYSYMBOL_layer_list = 27,                /* layer_list  */
  YYSYMBOL_layer_expression = 28,          /* layer_expression  */
  YYSYMBOL_29_1 = 29,                      /* $@1  */
  YYSYMBOL_geom_expr = 30,                 /* geom_expr  */
  YYSYMBOL_layered_geom_list = 31,         /* layered_geom_list  */
  YYSYMBOL_using_clause = 32,              /* using_clause  */
  YYSYMBOL_from_clause = 33,               /* from_clause  */
  YYSYMBOL_aes_mappings = 34,              /* aes_mappings  */
  YYSYMBOL_aes_mapping = 35,               /* aes_mapping  */
  YYSYMBOL_col_expr = 36,                  /* col_expr  */
  YYSYMBOL_grouping_clause = 37,           /* grouping_clause  */
  YYSYMBOL_grouping_list = 38,             /* grouping_list  */
  YYSYMBOL_grouping_expr = 39,             /* grouping_expr  */
  YYSYMBOL_collection_clause = 40,         /* collection_clause  */
  YYSYMBOL_collection_list = 41,           /* collection_list  */
  YYSYMBOL_collection_expr = 42,           /* collection_expr  */
  YYSYMBOL_scale_clause = 43,              /* scale_clause  */
  YYSYMBOL_scale_list = 44,                /* scale_list  */
  YYSYMBOL_scale_expr = 45,                /* scale_expr  */
  YYSYMBOL_facet_clause = 46,              /* facet_clause  */
  YYSYMBOL_facet_list = 47,                /* facet_list  */
  YYSYMBOL_facet_expr = 48,                /* facet_expr  */
  YYSYMBOL_direction = 49,                 /* direction  */
  YYSYMBOL_title_clause = 50,              /* title_clause  */
  YYSYMBOL_title_list = 51,                /* title_list  */
  YYSYMBOL_title_expr = 52                 /* title_expr  */
};
...
static const yytype_int16 yyrline[] =
{
      ...
      56,    56,    66,    95,   117,   118,   120,   121,   123,   131,
     137,   138,   140,   161,   180,   191,   192,   194,   195,   197,
     206,   207,   209,   210,   212,   221,   223,   224,   226,   258,
     260,   261,   263,   277,   278,   279,   281,   283,   284,   286
};
#endif
...
static const char *const yytname[] =
{
  ...
  "SQL_SUBQUERY", "UNQUOTED_STRING", "SINGLE_QUOTED_STRING", "'('", "')'",
  "$accept", "statement", "graphic_clauses", "graphic_clause",
  "layer_list", "layer_expression", "$@1", "geom_expr",
  "layered_geom_list", "using_clause", "from_clause", "aes_mappings",
  "aes_mapping", "col_expr", "grouping_clause", "grouping_list",
...
{
       2,   -72,     7,     0,   -72,     4,   -72,     2,     5,    -8,
      -2,   -72,    13,   -72,    12,     8,    14,   -72,   -72,   -72,
     -72,     9,    -6,     4,    19,    11,    15,    27,    22,   -72,
      16,    17,   -72,   -72,   -72,    21,    29,   -72,    20,    28,
     -72,    23,     8,     6,    30,   -72,   -72,     4,    25,    34,
      26,    15,   -72,   -72,   -72,   -72,   -72,    16,   -72,    36,
     -72,     4,   -15,   -72,    31,   -72,   -72,     4,   -72,    37,
     -72,    32,    33,   -72,   -72,   -72,     4,   -72,   -72,    -7,
     -72,    33,   -72,   -72
};
...
{
       0,    10,     0,     3,     8,     0,     1,     0,     2,    24,
       0,    20,     0,     9,     0,     0,     0,     4,     5,     6,
       7,     0,     0,     0,    25,     0,     0,     0,    46,    47,
       0,     0,    18,    19,    21,     0,    30,    22,     0,    35,
      36,     0,     0,    43,    39,    40,    23,     0,     0,     0,
       0,     0,    49,    48,    44,    45,    42,     0,    29,    26,
      27,     0,     0,    11,     0,    37,    41,     0,    34,    31,
      32,    13,     0,    16,    38,    28,     0,    12,    14,     0,
      33,     0,    17,    15
};
...
{
     -72,   -72,   -72,   -72,   -72,    41,   -72,   -71,   -72,   -72,
     -72,   -72,    35,   -47,   -72,   -72,   -23,   -72,   -72,   -27,
     -72,   -72,    -1,   -72,   -72,    -3,   -72,   -72,   -72,    18
};

/* YYDEFGOTO[NTERM-NUM].  */
static const yytype_int8 yydefgoto[] =
{
       0,     2,     8,    17,     3,     4,     5,    73,    79,    63,
      24,    10,    11,    12,    36,    59,    60,    49,    69,    70,
      18,    39,    40,    19,    44,    45,    56,    20,    28,    29
};
...
{
      58,    78,    81,    22,    71,     1,    72,     6,    23,     7,
      83,    32,    33,    21,    68,    82,    14,    25,    15,    16,
      58,    54,    55,     9,    26,    35,    30,    27,    31,    68,
      37,    41,    42,    47,    38,    43,    48,    61,    51,    46,
      57,    50,    62,    52,    75,    64,    67,    76,    13,    80,
      65,    77,    71,    74,    66,     0,     0,     0,    34,     0,
      53
};

static const yytype_int8 yycheck[] =
{
      47,    72,     9,     5,    19,     3,    21,     0,    10,     9,
      81,    17,    18,    21,    61,    22,    11,     4,    13,    14,
      67,    15,    16,    19,    12,     6,    12,    19,    19,    76,
      19,     4,    10,    12,    19,    19,     7,    12,    10,    22,
      10,    21,     8,    20,    67,    19,    10,    10,     7,    76,
      51,    19,    19,    22,    57,    -1,    -1,    -1,    23,    -1,
      42
};
...
{
       0,     3,    24,    27,    28,    29,     0,     9,    25,    19,
      34,    35,    36,    28,    11,    13,    14,    26,    43,    46,
      50,    21,     5,    10,    33,     4,    12,    19,    51,    52,
      12,    19,    17,    18,    35,     6,    37,    19,    19,    44,
      45,     4,    10,    19,    47,    48,    22,    12,     7,    40,
      21,    10,    20,    52,    15,    16,    49,    10,    36,    38,
      39,    12,     8,    32,    19,    45,    48,    10,    36,    41,
      42,    19,    21,    30,    22,    39,    10,    19,    30,    31,
      42,     9,    22,    30
};
...
#line 1337 "src/parser.tab.c"
  ...
  case 24: /* col_expr: UNQUOTED_STRING  */
...
#line 1352 "src/parser.tab.c"
  ...
  case 29: /* grouping_expr: col_expr  */
...
#line 1365 "src/parser.tab.c"
  ...
  case 34: /* collection_expr: col_expr  */
...
#line 1378 "src/parser.tab.c"
  ...
  case 35: /* scale_clause: SCALE BY scale_list  */
#line 221 "src/parser.y"
                                  {}
#line 1384 "src/parser.tab.c"
    break;

  case 38: /* scale_expr: UNQUOTED_STRING '(' UNQUOTED_STRING ')'  */
...
#line 1420 "src/parser.tab.c"
  ...
  case 39: /* facet_clause: FACET BY facet_list  */
#line 258 "src/parser.y"
                                  {}
#line 1426 "src/parser.tab.c"
    break;

  case 42: /* facet_expr: UNQUOTED_STRING direction  */
...
#line 1444 "src/parser.tab.c"
  ...
  case 43: /* direction: %empty  */
#line 277 "src/parser.y"
           { (yyval.direction_enum) = DEFAULT_DIRECTION; }
#line 1450 "src/parser.tab.c"
    break;

  case 44: /* direction: HORIZONTALLY  */
#line 278 "src/parser.y"
               { (yyval.direction_enum) = HORIZONTAL; }
#line 1456 "src/parser.tab.c"
    break;

  case 45: /* direction: VERTICALLY  */
#line 279 "src/parser.y"
             { (yyval.direction_enum) = VERTICAL; }
#line 1462 "src/parser.tab.c"
    break;

  case 46: /* title_clause: TITLE title_list  */
#line 281 "src/parser.y"
                               {}
#line 1468 "src/parser.tab.c"
    break;

  case 49: /* title_expr: UNQUOTED_STRING AS SINGLE_QUOTED_STRING  */
